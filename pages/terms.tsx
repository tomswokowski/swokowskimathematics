...
const Terms = () => {
  return (
    <div className="max-w-5xl">
      <Head>
        <title>Algebra Source | Terms & Conditions</title>
      </Head>
      <div className="mb-8">
        <h1 className="text-3xl font-semibold">Terms and Conditions</h1>
        <p className="mb-2 text-xs">Last updated: June 02, 2022</p>
        <p>
          Please read these terms and conditions carefully before using Our
          Service.
        </p>
      </div>
      <h2 className="mb-4 text-2xl">Interpretation and Definitions</h2>
      ...
      <ul className="mb-8">
        ...
        <li>
          <p className="mb-2 text-sm">
            ...
            this Agreement) refers to Swokowski LLC
          </p>
        </li>
        <li>
          <p className="mb-2 text-sm">
        ...
        <li>
          <p className="mb-2 text-sm">
            <strong>Website</strong> refers to Algebra Source, accessible from{' '}
            <Link href="/">
              <a className="underline">https://algebrasource.com</a>
            </Link>
          </p>
        </li>
        <li>
      ...
      <h2 className="mb-4 text-2xl">Acknowledgment</h2>
      <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">Links to Other Websites</h2>
      <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">Termination</h2>
      <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">Limitation of Liability</h2>
      <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">Governing Law</h2>
      <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">Disputes Resolution</h2>
      <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">For European Union (EU) Users</h2>
      <p className="mb-2 text-sm">
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <h2 className="mb-4 text-2xl">United States Legal Compliance</h2>
      <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">Severability and Waiver</h2>
      ...
      <h2 className="mb-4 text-2xl">Translation Interpretation</h2>
      <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">Changes to These Terms and Conditions</h2>
      <p className="mb-2 text-sm">
      ...
      <ul className="mb-2 text-sm">
        <li>By email: john@swokowskimathematics.com</li>
      </ul>
    </div>
  );
};
