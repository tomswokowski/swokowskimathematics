...
const Privacy = () => {
  return (
    <div className="max-w-5xl">
      <Head>
        <title>Algebra Source | Privacy Policy</title>
      </Head>
      <div className="mb-8">
      ...
      <h3 className="underline mt-4 text-lg">Interpretation</h3>
      ...
      <h3 className="underline mt-4 text-lg">Definitions</h3>
      <p className="mb-2 text-sm">For the purposes of this Privacy Policy:</p>
      <ul>
        <li>
          <p className="mb-2 text-sm">
        ...
        <li>
          <p className="mb-2 text-sm">
            ...
            this Agreement) refers to Algebra Source.
          </p>
        </li>
        <li>
          <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">Collecting and Using Your Personal Data</h2>
      <h3 className="underline mt-4 text-lg">Types of Data Collected</h3>
      ...
      <ul>
        ...
        <li>
          <p className="mb-2 text-sm">Usage Data</p>
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          <p className="mb-2 text-sm">Type: Session Cookies</p>
          <p className="mb-2 text-sm">Administered by: Us</p>
          <p className="mb-2 text-sm">
        ...
        <li>
          ...
          <p className="mb-2 text-sm">Type: Persistent Cookies</p>
          <p className="mb-2 text-sm">Administered by: Us</p>
          <p className="mb-2 text-sm">
        ...
        <li>
          ...
          <p className="mb-2 text-sm">Type: Persistent Cookies</p>
          <p className="mb-2 text-sm">Administered by: Third-Parties</p>
          <p className="mb-2 text-sm">
      ...
      <h3 className="underline mt-4 text-lg">Use of Your Personal Data</h3>
      ...
      <h3 className="underline mt-4 text-lg">Retention of Your Personal Data</h3>
      <p className="mb-2 text-sm">
      ...
      <h3 className="underline mt-4 text-lg">Transfer of Your Personal Data</h3>
      <p className="mb-2 text-sm">
      ...
      <h3 className="underline mt-4 text-lg">Disclosure of Your Personal Data</h3>
      ...
      <ul>
        <li className="mb-2 text-sm">Comply with a legal obligation</li>
        <li className="mb-2 text-sm">
        ...
        <li className="mb-2 text-sm">Protect against legal liability</li>
      </ul>
      <h3 className="underline mt-4 text-lg">Security of Your Personal Data</h3>
      <p className="mb-2 text-sm">
      ...
      <h3 className="underline mt-4 text-lg">Analytics</h3>
      <p className="mb-2 text-sm">
      ...
      <h3 className="underline mt-4 text-lg">Email Marketing</h3>
      <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">Children&apos;s Privacy</h2>
      <p className="mb-2 text-sm">
      ...
      <h2 className="mb-4 text-2xl">Changes to this Privacy Policy</h2>
      <p className="mb-2 text-sm">
