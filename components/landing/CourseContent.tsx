    ...
    <div className='bg-white'>
      <div className='mx-auto max-w-7xl py-16 px-4 sm:px-6 lg:grid lg:grid-cols-3 lg:gap-x-20 lg:py-24 lg:px-8'>
        ...
        <div className='mt-12 lg:col-span-2 lg:mt-0'>
          <dl className='space-y-10 sm:grid sm:grid-cols-2 sm:grid-rows-4 sm:gap-x-6 sm:gap-y-10 sm:space-y-0 lg:gap-x-4'>
              ...
              <div key={feature.name} className='relative'>
                <dt>
                  <CheckIcon
                    ...
                    aria-hidden='true'
                  />
                  <p className='ml-9 text-base font-medium leading-6 text-gray-900'>
                    {feature.name}
                  </p>
                </dt>
              </div>
